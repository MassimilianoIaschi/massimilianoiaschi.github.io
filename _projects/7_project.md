...
In this paper, we build on this already advantageous mechanical intelligence through the addition of **low-bandwidth tactile sensing**, a compliant antenna plus binary foot contacts, and a **simple feedback controller** that are able to estimate the geometry of an obstacle, modulate just two vertical joints to “raise, hook, and drag” the body over it and successfully climb it. 
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <video width="100%" controls>
            <source src="{{ '/assets/img/juntao_rss.mp4' | relative_url }}" type="video/mp4">
